...
layout = dbc.Container([
    ...
    html.Div(id='index-2017-lri', children=[], style={"visibility": "hidden"}),
    html.Div(id='index-2019-lri', children=[], style={"visibility": "hidden"}),
    ...
    dbc.Row([
        dbc.Col([
            dcc.Markdown(id='word-2017-lri'),
            dash_table.DataTable(id='full-table-2017-lri',
                                  data=[],
                                  page_size=15,
        ...
        dbc.Col([
            ...
            dcc.Graph(id='all-countries-2017-lri', figure={})
            ])
        ]),
    html.Br(),
    html.Br(),
    ...
    dbc.Row([
        dbc.Col([
            dcc.Markdown(id='word-2019-lri'),
            dash_table.DataTable(id='full-table-2019-lri',
                                  data=[],
                                  page_size=15,
                                  fixed_columns={'headers': True, 'data': 1},
                                  style_cell={'padding': '5px'},
        ...
        dbc.Col([
            ...
            dcc.Graph(id='all-countries-2019-lri', figure={})
            ])
        ]),
    ...
    dbc.Row([
        dbc.Col([
            html.Div([
                dcc.Markdown(id='markdown-2017-lri'),
                dcc.Markdown(id='markdown-top-3-countries-2017-lri'),
                ]),
            
            html.Br(),
            
            html.Div([
                dcc.Markdown(id='totals-2017-lri'),
                dcc.Markdown(id='markdown-top-3-total-2017-lri')
                ]),
            ]),
        
        dbc.Col([
            html.Div([
                dcc.Markdown(id='markdown-2019-lri'),
                dcc.Markdown(id='markdown-top-3-countries-2019-lri'),
                ]),
            
            html.Br(),
            
            html.Div([
                dcc.Markdown(id='totals-2019-lri'),
                dcc.Markdown(id='markdown-top-3-total-2019-lri')
                ]),
            ]),
        ]),
    ...
    dbc.Row([
        dcc.Markdown('''
                     ...
                     '''),
        dcc.Graph(id='graph-abs-lri', figure={})
        ]),
    ...
    dbc.Row([
        dcc.Markdown('''
                     ...
                     '''),
        dcc.Graph(id='graph-percent-lri', figure={})
        ]),
    ...
    dcc.Markdown(id='barchart-2017-lri'),
    
    dbc.Row([
        dbc.Col([
            dcc.Dropdown(id='select-list-id-input-lri', options=[], value=0,
                          placeholder='select list of countries...'),
            
            html.Div(id='select-list-id-output-lri', children=[], style={"visibility": "hidden"}),
            dcc.Dropdown(id='select-country-lri', options=[],
            ...
            dcc.Graph(id='Barchart-all-countries-2017-lri', figure={}),
            ]),
        
        dbc.Col([
            dcc.Dropdown(id='select-one-country-input-lri', options=[],
                          placeholder='select country...'),
            ...
            html.Div(id='select-one-country-output-lri', children=[]),
            
            #dcc.Markdown(id='barchart-2019'),
            dcc.Graph(id='Barchart-by-country-2017-lri', figure={})
            ]),
        ]),
    html.Br(),
    html.Br(),
    ...
    dcc.Markdown(id='barchart-2019-lri'),
    
    dbc.Row([
        dbc.Col([
            dcc.Graph(id='Barchart-all-countries-2019-lri', figure={})
            ]),
        dbc.Col([
            dcc.Graph(id='Barchart-by-country-2019-lri', figure={})
            ])
        ])
    ])
...
@callback(
    Output('index-2017-lri', 'children'),
...
@callback(
    Output('index-2019-lri', 'children'),
    Input('store-words-years-indexes', 'data')
    )
def fn_index_2019(l):
    l_ = []
...
@callback(
    Output('markdown-2017-lri', 'children'),
    Input('store-words-years-indexes', 'data')
    )
...
@callback(
    Output('markdown-2019-lri', 'children'),
    Input('store-words-years-indexes', 'data')
    )
...
@callback(
    [Output('full-table-2017-lri', 'data'),
      Output('full-table-2017-lri', 'columns'),
      Output('markdown-top-3-countries-2017-lri', 'children'),
      Output('markdown-top-3-total-2017-lri', 'children')],
    Input('store-1', 'data')
    )
...
@callback(
    [Output('full-table-2019-lri', 'data'),
      Output('full-table-2019-lri', 'columns'),
      Output('markdown-top-3-countries-2019-lri', 'children'),
      Output('markdown-top-3-total-2019-lri', 'children')],
    Input('store-12', 'data')
    )
...
@callback(
    [Output('graph-percent-lri', 'figure'),
     Output('graph-abs-lri', 'figure')],
    [Input('store-1', 'data'),
     Input('store-12', 'data')]
    )
...
@callback(
    Output('select-list-id-input-lri', 'options'),
...
@callback(
    Output('barchart-2017-lri', 'children'),
    Input('store-words-years-indexes', 'data')
    )
...
@callback(
    Output('barchart-2019-lri', 'children'),
    Input('store-words-years-indexes', 'data')
    )
...
@callback(
    Output('all-countries-2017-lri', 'figure'),
    Input('store-1', 'data')
    )
...
@callback(
    Output('all-countries-2019-lri', 'figure'),
    Input('store-12', 'data')
    )
...
@callback(
    Output('select-list-id-output-lri', 'children'),
    Input('select-list-id-input-lri', 'value')
    )
...
@callback([
    Output('select-country-lri', 'options'),
    Output('select-country-lri', 'value')],
    [Input('select-list-id-output-lri', 'children'),
      Input('store-list-dict','data')]
    )
...
@callback(
    [Output('Barchart-all-countries-2017-lri', 'figure'),
     Output('Barchart-all-countries-2019-lri', 'figure')],
    [Input('store-1', 'data'),
     Input('store-12', 'data'),
      Input('select-country-lri', 'value')]
    )
...
@callback(
    [Output('select-one-country-input-lri', 'options'),
      Output('select-one-country-input-lri', 'value')],
    [Input('select-list-id-output-lri', 'children'),
     Input('store-list-dict', 'data')]
    )
...
@callback(
    [Output('Barchart-by-country-2017-lri', 'figure'),
     Output('Barchart-by-country-2019-lri', 'figure')],
    [Input('store-1', 'data'),
     Input('store-12', 'data'),
      Input('select-one-country-input-lri', 'value')]
    )
