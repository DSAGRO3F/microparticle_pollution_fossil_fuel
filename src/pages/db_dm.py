...
layout = dbc.Container([
    ...
    html.Div(id='index-2017-dm', children=[], style={"visibility": "hidden"}),
    html.Div(id='index-2019-dm', children=[], style={"visibility": "hidden"}),
    ...
    dbc.Row([
        dbc.Col([
            dcc.Markdown(id='word-2017-dm'),
            dash_table.DataTable(id='full-table-2017-dm',
                                  data=[],
                                  page_size=15,
        ...
        dbc.Col([
            ...
            dcc.Graph(id='all-countries-2017-dm', figure={})
            ])
        ]),
    ...
    dbc.Row([
        dbc.Col([
            dcc.Markdown(id='word-2019-dm'),
            dash_table.DataTable(id='full-table-2019-dm',
                                  data=[],
                                  page_size=15,
                                  fixed_columns={'headers': True, 'data': 1},
                                  style_cell={'padding': '5px'},
        ...
        dbc.Col([
            ...
            dcc.Graph(id='all-countries-2019-dm', figure={})
            ])
        ]),
    ...
    dbc.Row([
        dbc.Col([
            html.Div([
                dcc.Markdown(id='markdown-2017-dm'),
                dcc.Markdown(id='markdown-top-3-countries-2017-dm'),
                ]),
            
            html.Br(),
            
            html.Div([
                dcc.Markdown(id='totals-2017-dm'),
                dcc.Markdown(id='markdown-top-3-total-2017-dm')
                ]),
            ]),
        
        dbc.Col([
            html.Div([
                dcc.Markdown(id='markdown-2019-dm'),
                dcc.Markdown(id='markdown-top-3-countries-2019-dm'),
                ]),
            
            html.Br(),
            
            html.Div([
                dcc.Markdown(id='totals-2019-dm'),
                dcc.Markdown(id='markdown-top-3-total-2019-dm')
                ]),
            ]),
        ]),
    ...
    dbc.Row([
        dcc.Markdown('''
                     ...
                     '''),
        dcc.Graph(id='graph-abs-dm', figure={})
        ]),
    ...
    dbc.Row([
        dcc.Markdown('''
                     ...
                     '''),
        dcc.Graph(id='graph-percent-dm', figure={})
        ]),
    ...
    dcc.Markdown(id='barchart-2017-dm'),
    
    dbc.Row([
        dbc.Col([
            dcc.Dropdown(id='select-list-id-input-dm', options=[], value=0,
                          placeholder='select list of countries...'),
            
            html.Div(id='select-list-id-output-dm', children=[], style={"visibility": "hidden"}),
            dcc.Dropdown(id='select-country-dm', options=[],
            ...
            dcc.Graph(id='Barchart-all-countries-2017-dm', figure={}),
            ]),
        
        dbc.Col([
            dcc.Dropdown(id='select-one-country-input-dm', options=[],
                          placeholder='select country...'),
            ...
            html.Div(id='select-one-country-output-dm', children=[]),
            
            #dcc.Markdown(id='barchart-2019'),
            dcc.Graph(id='Barchart-by-country-2017-dm', figure={})
            ]),
        ]),
    html.Br(),
    html.Br(),
    ...
    dcc.Markdown(id='barchart-2019-dm'),
    
    dbc.Row([
        dbc.Col([
            dcc.Graph(id='Barchart-all-countries-2019-dm', figure={})
            ]),
        dbc.Col([
            dcc.Graph(id='Barchart-by-country-2019-dm', figure={})
            ])
        ])
    ])
...
@callback(
    Output('markdown-2017-dm', 'children'),
    Input('store-words-years-indexes', 'data')
    )
...
@callback(
    Output('markdown-2019-dm', 'children'),
    Input('store-words-years-indexes', 'data')
    )
...
@callback(
    [Output('full-table-2017-dm', 'data'),
      Output('full-table-2017-dm', 'columns'),
      Output('markdown-top-3-countries-2017-dm', 'children'),
      Output('markdown-top-3-total-2017-dm', 'children')],
    Input('store-2', 'data')
    )
...
@callback(
    [Output('full-table-2019-dm', 'data'),
      Output('full-table-2019-dm', 'columns'),
      Output('markdown-top-3-countries-2019-dm', 'children'),
      Output('markdown-top-3-total-2019-dm', 'children')],
    Input('store-13', 'data')
    )
...
@callback(
    [Output('graph-percent-dm', 'figure'),
     Output('graph-abs-dm', 'figure')],
    [Input('store-2', 'data'),
     Input('store-13', 'data')]
    )
...
@callback(
    Output('select-list-id-input-dm', 'options'),
...
@callback(
    Output('barchart-2017-dm', 'children'),
    Input('store-words-years-indexes', 'data')
    )
...
@callback(
    Output('barchart-2019-dm', 'children'),
    Input('store-words-years-indexes', 'data')
    )
...
@callback(
    Output('all-countries-2017-dm', 'figure'),
    Input('store-2', 'data')
    )
...
@callback(
    Output('all-countries-2019-dm', 'figure'),
    Input('store-13', 'data')
    )
...
@callback(
    Output('select-list-id-output-dm', 'children'),
    Input('select-list-id-input-dm', 'value')
    )
...
@callback([
    Output('select-country-dm', 'options'),
    Output('select-country-dm', 'value')],
    [Input('select-list-id-output-dm', 'children'),
      Input('store-list-dict','data')]
    )
...
@callback(
    [Output('Barchart-all-countries-2017-dm', 'figure'),
     Output('Barchart-all-countries-2019-dm', 'figure')],
    [Input('store-2', 'data'),
     Input('store-13', 'data'),
      Input('select-country-dm', 'value')]
    )
...
@callback(
    [Output('select-one-country-input-dm', 'options'),
      Output('select-one-country-input-dm', 'value')],
    [Input('select-list-id-output-dm', 'children'),
     Input('store-list-dict', 'data')]
    )
...
@callback(
    [Output('Barchart-by-country-2017-dm', 'figure'),
     Output('Barchart-by-country-2019-dm', 'figure')],
    [Input('store-2', 'data'),
     Input('store-13', 'data'),
      Input('select-one-country-input-dm', 'value')]
    )
