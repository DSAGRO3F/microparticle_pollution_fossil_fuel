...
layout = dbc.Container([
    ...
    html.Div(id='index-2017-lc', children=[], style={"visibility": "hidden"}),
    html.Div(id='index-2019-lc', children=[], style={"visibility": "hidden"}),
    ...
    dbc.Row([
        dbc.Col([
            dcc.Markdown(id='word-2017-lc'),
            dash_table.DataTable(id='full-table-2017-lc',
                                  data=[],
                                  page_size=15,
        ...
        dbc.Col([
            ...
            dcc.Graph(id='all-countries-2017-lc', figure={})
            ])
        ]),
    ...
    dbc.Row([
        dbc.Col([
            dcc.Markdown(id='word-2019-lc'),
            dash_table.DataTable(id='full-table-2019-lc',
                                  data=[],
                                  page_size=15,
                                  fixed_columns={'headers': True, 'data': 1},
                                  style_cell={'padding': '5px'},
        ...
        dbc.Col([
            ...
            dcc.Graph(id='all-countries-2019-lc', figure={})
            ])
        ]),
    ...
    dbc.Row([
        dbc.Col([
            html.Div([
                dcc.Markdown(id='markdown-2017-lc'),
                dcc.Markdown(id='markdown-top-3-countries-2017-lc'),
                ]),
            
            html.Br(),
            
            html.Div([
                dcc.Markdown(id='totals-2017-lc'),
                dcc.Markdown(id='markdown-top-3-total-2017-lc')
                ]),
            ]),
        
        dbc.Col([
            html.Div([
                dcc.Markdown(id='markdown-2019-lc'),
                dcc.Markdown(id='markdown-top-3-countries-2019-lc'),
                ]),
            
            html.Br(),
            
            html.Div([
                dcc.Markdown(id='totals-2019-lc'),
                dcc.Markdown(id='markdown-top-3-total-2019-lc')
                ]),
            ]),
        ]),
    ...
    dbc.Row([
        dcc.Markdown('''
                     ...
                     '''),
        dcc.Graph(id='graph-abs-lc', figure={})
        ]),
    ...
    dbc.Row([
        dcc.Markdown('''
                     ...
                     '''),
        dcc.Graph(id='graph-percent-lc', figure={})
        ]),
    ...
    dcc.Markdown(id='barchart-2017-lc'),
    
    dbc.Row([
        dbc.Col([
            dcc.Dropdown(id='select-list-id-input-lc', options=[], value=0,
                          placeholder='select list of countries...'),
            
            html.Div(id='select-list-id-output-lc', children=[], style={"visibility": "hidden"}),
            dcc.Dropdown(id='select-country-lc', options=[],
            ...
            dcc.Graph(id='Barchart-all-countries-2017-lc', figure={}),
            ]),
        
        dbc.Col([
            dcc.Dropdown(id='select-one-country-input-lc', options=[],
                          placeholder='select country...'),
            ...
            html.Div(id='select-one-country-output-lc', children=[]),
            
            #dcc.Markdown(id='barchart-2019'),
            dcc.Graph(id='Barchart-by-country-2017-lc', figure={})
            ]),
        ]),
    html.Br(),
    html.Br(),
    ...
    dcc.Markdown(id='barchart-2019-lc'),
    
    dbc.Row([
        dbc.Col([
            dcc.Graph(id='Barchart-all-countries-2019-lc', figure={})
            ]),
        dbc.Col([
            dcc.Graph(id='Barchart-by-country-2019-lc', figure={})
            ])
        ])
    ])
...
@callback(
    Output('markdown-2017-lc', 'children'),
    Input('store-words-years-indexes', 'data')
    )
...
@callback(
    Output('markdown-2019-lc', 'children'),
    Input('store-words-years-indexes', 'data')
    )
...
@callback(
    [Output('full-table-2017-lc', 'data'),
      Output('full-table-2017-lc', 'columns'),
      Output('markdown-top-3-countries-2017-lc', 'children'),
      Output('markdown-top-3-total-2017-lc', 'children')],
    Input('store-6', 'data')
    )
...
@callback(
    [Output('full-table-2019-lc', 'data'),
      Output('full-table-2019-lc', 'columns'),
      Output('markdown-top-3-countries-2019-lc', 'children'),
      Output('markdown-top-3-total-2019-lc', 'children')],
    Input('store-9', 'data')
    )
...
@callback(
    [Output('graph-percent-lc', 'figure'),
     Output('graph-abs-lc', 'figure')],
    [Input('store-6', 'data'),
     Input('store-9', 'data')]
    )
...
@callback(
    Output('select-list-id-input-lc', 'options'),
...
@callback(
    Output('barchart-2017-lc', 'children'),
    Input('store-words-years-indexes', 'data')
    )
...
@callback(
    Output('barchart-2019-lc', 'children'),
    Input('store-words-years-indexes', 'data')
    )
...
@callback(
    Output('all-countries-2017-lc', 'figure'),
    Input('store-6', 'data')
    )
...
@callback(
    Output('all-countries-2019-lc', 'figure'),
    Input('store-9', 'data')
    )
...
@callback(
    Output('select-list-id-output-lc', 'children'),
    Input('select-list-id-input-lc', 'value')
    )
...
@callback([
    Output('select-country-lc', 'options'),
    Output('select-country-lc', 'value')],
    [Input('select-list-id-output-lc', 'children'),
      Input('store-list-dict','data')]
    )
...
@callback(
    [Output('Barchart-all-countries-2017-lc', 'figure'),
     Output('Barchart-all-countries-2019-lc', 'figure')],
    [Input('store-6', 'data'),
     Input('store-9', 'data'),
      Input('select-country-lc', 'value')]
    )
...
@callback(
    [Output('select-one-country-input-lc', 'options'),
      Output('select-one-country-input-lc', 'value')],
    [Input('select-list-id-output-lc', 'children'),
     Input('store-list-dict', 'data')]
    )
...
@callback(
    [Output('Barchart-by-country-2017-lc', 'figure'),
     Output('Barchart-by-country-2019-lc', 'figure')],
    [Input('store-6', 'data'),
     Input('store-9', 'data'),
      Input('select-one-country-input-lc', 'value')]
    )
