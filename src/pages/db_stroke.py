...
layout = dbc.Container([
    ...
    html.Div(id='index-2017', children=[], style={"visibility": "hidden"}),
    html.Div(id='index-2019', children=[], style={"visibility": "hidden"}),
    ...
    dbc.Row([
        dcc.Markdown('''
                     ...
                     '''),
        dcc.Graph(id='graph-percent', figure={})
        ]),
    ...
    dcc.Markdown(id='barchart-2017'),
    
    dbc.Row([
        dbc.Col([
            dcc.Dropdown(id='select-list-id-input', options=[], value=0,
                          placeholder='select list of countries...'),
            
            html.Div(id='select-list-id-output', children=[], style={"visibility": "hidden"}),
            ...
            dcc.Graph(id='Barchart-all-countries-2017', figure={}),
            ]),
        ...
        dbc.Col([
            ...
            dcc.Graph(id='Barchart-by-country-2017', figure={})
            ]),
        ]),
    html.Br(),
    html.Br(),
    ...
    dbc.Row([
        dbc.Col([
            dcc.Graph(id='Barchart-all-countries-2019', figure={})
            ]),
        dbc.Col([
            dcc.Graph(id='Barchart-by-country-2019', figure={})
            ])
        ])
    ])
...
@callback(
    Output('select-list-id-input', 'options'),
...
@callback(
    [Output('Barchart-all-countries-2017', 'figure'),
     Output('Barchart-all-countries-2019', 'figure')],
    [Input('store-0', 'data'),
     Input('store-4', 'data'),
...
@callback(
    [Output('Barchart-by-country-2017', 'figure'),
     Output('Barchart-by-country-2019', 'figure')],
    [Input('store-0', 'data'),
     Input('store-4', 'data'),
